...
# Helpers for readability of our name-keyed merge blocks -------------------
...
text = one(text, '{{- toYaml . | nindent 10 }}', '{{-   toYaml . | nindent 10 }}', 'formatted merged output')
...
text = exact_all(text, '{{- toYaml . | nindent 14 }}', '{{-   toYaml . | nindent 14 }}', 2, 'ray mount outputs')
